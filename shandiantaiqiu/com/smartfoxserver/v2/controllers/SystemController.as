package com.smartfoxserver.v2.controllers
{
   ...
   public class SystemController extends BaseController
   {
      ...
      private function fnLogin(msg:IMessage) : void
      {
         ...
         {
            errorMsg = SFSErrorCodes.getErrorMessage(obj.getShort(BaseRequest.KEY_ERROR_CODE),obj.getUtfStringArray(BaseRequest.KEY_ERROR_PARAMS));
            evtParams = {
               "success":false,
      ...
      private function fnCreateRoom(msg:IMessage) : void
      {
         ...
         {
            errorMsg = SFSErrorCodes.getErrorMessage(obj.getShort(BaseRequest.KEY_ERROR_CODE),obj.getUtfStringArray(BaseRequest.KEY_ERROR_PARAMS));
            evtParams = {"errorMessage":errorMsg};
      ...
      private function fnJoinRoom(msg:IMessage) : void
      {
         ...
         {
            errorMsg = SFSErrorCodes.getErrorMessage(sfso.getShort(BaseRequest.KEY_ERROR_CODE),sfso.getUtfStringArray(BaseRequest.KEY_ERROR_PARAMS));
            evtParams = {"errorMessage":errorMsg};
